//Credit https://www.geeksforgeeks.org/java-swing-creating-toast-message/
...
public class toast extends JFrame {
	...
	private void showtoast()
	{
        ...
        public static void ShowToastMsg(String strMessage, int x, int y)
        {
                // create a toast message
        toast t = new toast(strMessage, x, y);
